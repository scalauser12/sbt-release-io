...
import _root_.sbt.Keys.resolvedScoped
import _root_.sbt.Keys.streams
import _root_.sbt.internal.*
import _root_.sbt.{internal as _, *}

/** Compatibility layer for _root_.sbt.Load which was made private in sbt 1.0.
